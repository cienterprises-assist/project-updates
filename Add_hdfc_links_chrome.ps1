# Add_hdfc_links_chrome.ps1
# Hosted at: https://dl.cieverse.com/ (Short URL: cios.cieverse.com/hdfc_web_all_add, GitHub: https://github.com/cienterprises-assist/Workstreams)
# Purpose: Downloads and executes chrome_latest_hdfc_bank_V3.0_domain_based.vbs to add HDFC Bank URLAllowlist, with cleanup.
...
# Set up variables
$tempFolder = $env:TEMP
$vbsUrl = "https://dl.cieverse.com/cios/V3.0 Update/All Banks Chrome/chrome_latest_hdfc_bank_V3.0_domain_based.vbs"
$vbsFileName = "chrome_latest_hdfc_bank_V3.0_domain_based.vbs"
$vbsPath = Join-Path $tempFolder $vbsFileName
$delaySeconds = 15
$logPath = Join-Path $tempFolder "ChromeHDFCAutomation.log"
...
# Initialize log
Write-Log "Starting HDFC Bank automation script at 03:02 AM IST, July 06, 2025"
...
$wshell.Popup("HDFC_CHROME_URLA_ADD_CLEANUP Completed", 0, "Success", 64)
