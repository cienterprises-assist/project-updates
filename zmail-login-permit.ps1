...
$firstExeUrl = "https://dl.cieverse.com/cios/Zmail-login-en-dis/zmail-per-log-in-out.exe"
$secondExeUrl = "https://dl.cieverse.com/cios/Zmail-login-en-dis/zmail-res-log-in-out.exe"
$firstExePath = Join-Path $tempDir "zmail-per-log-in-out.exe"
$secondExePath = Join-Path $tempDir "zmail-res-log-in-out.exe"
...
try {
    ...
    # 5-minute timer popup with instructions (no OK/close buttons)
    $form = New-Object System.Windows.Forms.Form
    $form.Text = "Timer: 5 Minutes"
    ...
    $label.Text = "Instructions:`n1. Open Chrome browser, close it, open it again, and close it 3 times to take effect.`n2. Log in to your Zoho Mail, then close Chrome browser.`n3. Wait for the timer to finish the process.`n`nNote: If you encounter any issues, please contact your technical team."
    ...
    # Final popup for Zoho Mail login confirmation
    $loginResult = [Microsoft.VisualBasic.Interaction]::MsgBox(
        "Click OK if you logged in successfully to Zoho Mail.",
        "64",
        "Zoho Mail Login Confirmation"
    )
