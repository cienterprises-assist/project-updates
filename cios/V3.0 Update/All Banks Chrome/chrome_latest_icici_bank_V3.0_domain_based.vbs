...
LogPath = TempFolder & "\ChromeURLAllowlistUpdate.log"
...
Else
    WScript.Echo "An error occurred while applying Chrome URLAllowlist policies. Check log at: " & LogPath, 0, "Error", 16
End If
