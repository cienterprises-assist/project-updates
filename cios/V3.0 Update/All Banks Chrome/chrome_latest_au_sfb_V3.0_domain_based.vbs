...
LogPath = TempFolder & "\ChromeAUSFBUpdate.log"
...
End If
On Error GoTo 0
LogFile.WriteLine "AU Small Finance Bank URLAllowlist Update Log - " & Now & " (IST)"

' String Value Names and Data
Dim ValueNames(0), ValueData(0)
ValueNames(0) = "501"
ValueData(0) = "encollect.aubank.in"
...
Else
    WScript.Echo "An error occurred while applying AU Small Finance Bank URLAllowlist policies. Check log at: " & LogPath, 0, "Error", 16
End If
