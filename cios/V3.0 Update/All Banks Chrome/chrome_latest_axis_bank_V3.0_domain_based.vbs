...
LogPath = TempFolder & "\ChromeAxisUpdate.log"
...
End If
On Error GoTo 0
LogFile.WriteLine "Axis Bank URLAllowlist Update Log - " & Now & " (IST)"

' String Value Names and Data
Dim ValueNames(8), ValueData(8)
ValueNames(0) = "501"
ValueData(0) = "axisallocation.axisbank.co.in"
ValueNames(1) = "601"
ValueData(1) = "collections.axisbank.co.in"
ValueNames(2) = "701"
ValueData(2) = "tap.tcsapps.com"
ValueNames(3) = "801"
ValueData(3) = "pcccollections.axisbank.co.in"
ValueNames(4) = "802"
ValueData(4) = "login.microsoftonline.com"
ValueNames(5) = "803"
ValueData(5) = "login.live.com"
ValueNames(6) = "804"
ValueData(6) = "adfs.axisbank.com"
ValueNames(7) = "805"
ValueData(7) = "adselfservice.axisbank.com"
ValueNames(8) = "806"
ValueData(8) = "mysignins.microsoft.com"
...
Else
    WScript.Echo "An error occurred while applying Axis Bank URLAllowlist policies. Check log at: " & LogPath, 0, "Error", 16
End If
