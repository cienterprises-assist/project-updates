...
Keys = Array( _
    ...
    "HKLM\Software\Policies\Microsoft\Edge\URLBlocklist\", _
    "HKLM\Software\Policies\Google\Chrome\URLAllowlist\", _
    "HKLM\Software\Policies\Google\Chrome\URLBlocklist\" _
)
...
If AllDeleted And ErrorCount = 0 Then
    WShell.Popup "All keys have been successfully deleted.", 0, "Success", 64
Else
