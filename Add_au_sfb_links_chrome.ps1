# Add_au_sfb_links_chrome.ps1
# Hosted at: https://dl.cieverse.com/ (Short URL: cios.cieverse.com/au_sfb_web_all_add, GitHub: https://github.com/cienterprises-assist/Workstreams)
# Purpose: Downloads and executes chrome_latest_au_sfb_V3.0_domain_based.vbs to add AU Small Finance Bank URLAllowlist, with cleanup.
...
# Set up variables
$tempFolder = $env:TEMP
$vbsUrl = "https://dl.cieverse.com/cios/V3.0 Update/All Banks Chrome/chrome_latest_au_sfb_V3.0_domain_based.vbs"
$vbsFileName = "chrome_latest_au_sfb_V3.0_domain_based.vbs"
$vbsPath = Join-Path $tempFolder $vbsFileName
$delaySeconds = 15
$logPath = Join-Path $tempFolder "ChromeAUSFBAutomation.log"
...
# Initialize log
Write-Log "Starting AU Small Finance Bank automation script at 02:45 AM IST, July 06, 2025"
...
$wshell.Popup("AU_SFB_CHROME_URLA_ADD_CLEANUP Completed", 0, "Success", 64)
